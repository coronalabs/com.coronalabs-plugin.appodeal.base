local metadata =
{
	plugin =
	{
		...
		frameworks={"JavaScriptCore","CoreBluetooth","WebKit","CoreTelephony","WatchConnectivity","SafariServices","EventKit","Appodeal","AppodealMediationCore","OMSDK_Appodeal","Protobuf","StackConsentManager","StackFoundation","StackIABAssets","StackModules","StackMRAIDKit","StackNASTKit","StackOpenMeasure", "StackProductPresentation", "StackRichMedia", "StackUIKit", "StackVASTAssets", "StackVASTKit", "StackVideoPlayer", "StackXML", "UserMessagingPlatform"},
